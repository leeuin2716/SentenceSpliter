...
import pandas as pd
import re,kss,os,time, datetime
...
def runing(csv_file_name):
    ...
    path_list = ['C:/SplitData/full_data/','C:/SplitData/division_data/']
    ...
    division_cnt = data_length//5000    # 분할개수 확인 
    if division_cnt == 0:
        division_cnt = 1
